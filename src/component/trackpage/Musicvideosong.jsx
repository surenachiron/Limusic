            ...
            <div className="h-200">
                {songalldetails.sections[1].youtubeurl !== undefined ?
                    <a href={songalldetails.sections[1].youtubeurl.actions.map(o => o.uri)} target="_blank">
                        <div className="bg-videobackgroundbeforewhow rounded-2xl mt-1 hover:bg-grayprolight transition-all h-full" style={{ backgroundImage: `url{songalldetails.sections[1].youtubeurl.image.url})` }} >
