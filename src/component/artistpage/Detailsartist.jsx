...
const Detailsartist = () => {
    ...
    return (
        <>
            <div className="flex lg:flex-row sm:flex-col lg:justify-start sm:justify-center sm:h-70/100 zero:bg-none sm:rounded-3xl zero:rounded-2xl items-center zero:mt-5 pictureartistsmtolg" style={{ backgroundColor: "#" + artistdetails.data.map(o => o.attributes.artwork.bgColor)[0] }}>
                ...
                <div className="sm:block zero:hidden z-10">
